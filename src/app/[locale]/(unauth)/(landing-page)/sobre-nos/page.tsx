            ...
            {TEAM.map((member, i) => (
              <RevealOnScroll key={member.name} delay={i * 100}>
                <a
                  ...
                  className="group block cursor-pointer overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.03] transition-all hover:border-white/10 hover:bg-white/[0.05]"
                >
